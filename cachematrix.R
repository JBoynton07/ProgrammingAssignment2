## When a matrix is input into makeCacheMatrix, 
...
##If there is not, it will: retrieve the value of the matrix set in get; 
##calculate and store the inverse function in m.local.inverse; 
##calls from setinverse so that the solve function will be stored in m for future use; 
##then print the Inverse Matrix. 
